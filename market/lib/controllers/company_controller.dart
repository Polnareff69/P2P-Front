...
class CompanyController {
  ...
  // Método inteligente para filtrar empresas del usuario actual
  ...
  // Método inteligente para obtener CompanyId del seller actual
  ...
  // Método para refresh forzado de datos de empresa
